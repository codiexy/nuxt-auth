/**
 * Definition of Auth endpoints to be used by the client.
 */
export interface CodiexyAuthEndpoints {
  /**
...
export interface ModuleOptions {
  ...
  /**
   * Auth endpoints to be used by the client.
   */
  endpoints: Partial<CodiexyAuthEndpoints>
  /**
   * CSRF token specific options.
   */
